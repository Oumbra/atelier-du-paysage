          ...
          <div className="two-col">
            <div>
              ...
              <p>
                ...
                <NavLink to="/entretien-annuel-jardin-17" style={{ color: 'var(--color-primary)', fontWeight: 600 }}>entretien</NavLink>.
              ...
              <h3 style={{ marginTop: '2rem', marginBottom: '1.5rem' }}>Nous travaillons sur les univers suivants :</h3>
              <ServicesGrid />
